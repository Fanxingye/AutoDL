...
class ImagePredictor(object):
    ...
    def fit(self,
        ...
        **kwargs :
        ...
        if config['early_stop_patience'] is None:
...
def _get_valid_labels(data):
    ...
    if ret is None:
        raise ValueError(
            'Dataset must be pandas.DataFrame or d8.image_classification.Dataset'
        )
    return ret
