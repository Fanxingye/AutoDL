...
def parse_args():
    ...
    parser.add_argument('--sampling_strategy', type=str, default='random', choices=['balanced', 'random'],
            ...
            if os.path.isdir(img_cls_dir):
                ...
                if len(img_cls_list) > 0:
                    ...
                    if sampling_strategy == "random":
                        ...
                        train_list, val_list, test_list = balanced_split(img_cls_list, val_ratio=val_ratio,
                                                                         test_ratio=test_ratio)

                copy_images(self.data_dir, self.train_path, img_cls, train_list)
