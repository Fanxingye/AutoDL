...
def parse_args():
    ...
    parser.add_argument('--report_path', type=str, default='', help='report dir to save the experiments results')
    ...
    parser.add_argument('--model_config', type=str, default='default',
                        choices=['search_models','big_models', 'best_quality', 'good_quality_fast_inference',
    ...
    if opt.train_framework == "autogluon":
        ...
        if not opt.checkpoint_path:
            ...
            if opt.load_best_model:
                predictor = None
                best_checkpoint, best_config, results = find_best_model(checkpoint_dir=output_directory)
