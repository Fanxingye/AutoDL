...
predictor.fit(train_dataset, hyperparameters={'model': ag.Categorical('resnet18_v1b', 'mobilenetv3'),
                                            'batch_size': ag.Categorical(32, 64),
                                            'lr': ag.Real(1e-4, 1e-2, log=True), 'epochs': 1, 'cleanup_disk': False},
                            hyperparameter_tune_kwargs={'num_trials': 2, 'max_reward': 1.0, 'searcher': 'random'},
