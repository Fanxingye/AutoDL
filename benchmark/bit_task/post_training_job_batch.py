...
datasetName_Path_dict = {
    ...
    "Google-Scraped-Image" : "/data/AutoML_compete/Google-Scraped-Image/split/",
    "MIT-Indoor-Scenes": "/data/AutoML_compete/MIT-Indoor-Scenes/split/"
}
...
for key in datasetName_Path_dict:
    ...
    for model_config in config_list:
        ...
        taskName = f"{datasetName}_{model_config}"
        payloadData = {"name": taskName, "jobTrainingType": "RegularJob",
                    "engine": "apulistech/autodl:v1",
                    "codePath": "/home/yiran.wu",
                    "startupFile": "/home/yiran.wu/wyr/code/bit_hpo/v3.1/train.py",
                    "outputPath": f"/home/yiran.wu/wyr/outputs/",
                    "datasetPath": dataSetPath, "deviceType": "nvidia_gpu_amd64_2080", "deviceNum": num_gpus,
                    "isPrivileged": False, "params":
                        {"data_path": datasetName,
                        "name": taskName,}, "private": True,
