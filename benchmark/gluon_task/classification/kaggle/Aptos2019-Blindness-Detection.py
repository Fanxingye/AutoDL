...
dataset_path = "../input/aptos2019-blindness-detection"
model_path = "/kaggle/input/gluonaptomodel/best_checkpoint.pkl"
...
generate_csv(images_name=test_result["image"].to_list(), preds_class=test_result["class"].to_list(),
             image_column_name="id_code", class_column_name="diagnosis",
             output_csv=f"submission.csv",fullname=False)
